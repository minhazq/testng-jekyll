...
<p>If you want to run using XML then you have to add "groups" tag right after "suite" tag declaration and inside the groups tag you add "run" tag and inside the run tag you add "include" tag. See there is no tag saying group. instead of group it says run. 
